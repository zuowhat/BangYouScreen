...
public class QuitGame {
	...
	private static QuitGame quitPopAd;
	
	public static QuitGame getInstance(){
		if(quitPopAd == null){
			quitPopAd = new QuitGame();
		}
		return quitPopAd;
	}
	...
	private LinearLayout getQuitView_Landscape(final Context context, final Dialog dialog){
		...
		//int height = (int)ResourceManager.getCamera().getWidth();
		//pop_layout = AppConnect.getInstance(context).getPopAdView(context, height/2, height/2);
